<?php
function ankletfoottampa_scripts()
{
    ...
    wp_enqueue_style('main', get_template_directory_uri() . '/assets/dist/css/app.css', array(), '1.0.2', 'all');
    wp_enqueue_script('theme-scripts', get_template_directory_uri() . '/assets/dist/js/app.js', array('jquery'), '0.2', true);
}
add_action('wp_enqueue_scripts', 'ankletfoottampa_scripts');
