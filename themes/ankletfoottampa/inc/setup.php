<?php
if (!function_exists('ankletfoottampa')) :
    /**
    ...
    */
        load_theme_textdomain('ankletfoottampa', get_template_directory() . '/languages');
...
add_action('after_setup_theme', 'ankletfoottampa');
