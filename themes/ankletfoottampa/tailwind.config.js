    ...
    plugins: [
        ...
        plugin(function ({ addUtilities }) {
            addUtilities({
                ...
                ".title--1": {
                    fontWeight: 700,
                    fontSize: "3.5rem", //64px
                    lineHeight: "3.8rem", //92px
                    letterSpacing: "0em",
                    textTransform: "uppercase",
                },
                ".title--2": {
